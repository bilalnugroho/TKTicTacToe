...
public class TicTacToe {
	...
	private void winningGame() 
	{
		...
		if (b1==("X") && b2==("X") && b3==("X"))
		{
			JOptionPane.showMessageDialog(frame, "Player X Wins","TicTac",JOptionPane.INFORMATION_MESSAGE);
			xCount++;
			gameScore();			
		}
		...
		if (b1==("O") && b2==("O") && b3==("O"))
		{
			JOptionPane.showMessageDialog(frame, "Player O Wins","TicTac",JOptionPane.INFORMATION_MESSAGE);
			oCount++;
			gameScore();			
		}
	...
	private void initialize() {
		...
		JLabel lblPlayerX = new JLabel("Score X");
		lblPlayerX.setFont(new Font("Franklin Gothic Medium Cond", Font.PLAIN, 40));
		...
		txtCountX.setFont(new Font("Franklin Gothic Medium", Font.PLAIN, 40));
		...
		JLabel lblPlayerO = new JLabel("Score O");
		lblPlayerO.setFont(new Font("Franklin Gothic Medium Cond", Font.PLAIN, 40));
		...
		txtCountO.setFont(new Font("Franklin Gothic Medium", Font.PLAIN, 40));
		...
		btnNewButton.setFont(new Font("Franklin Gothic Medium Cond", Font.PLAIN, 40));
		panel_14.add(btnNewButton, BorderLayout.CENTER);
		
		JLabel lblNewLabel = new JLabel("Tic Tac Toe");
		lblNewLabel.setFont(new Font("Franklin Gothic Medium Cond", Font.PLAIN, 40));
